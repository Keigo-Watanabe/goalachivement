    ...
    <div class="my-page-main">
      ...
      <div class="create-content goal-create">
        ...
        <form class="create-form goal-create-form" action="/goal" method="post">
          {{ csrf_field() }}
          <label for=""><span class="create-step">Step1.</span>目標を設定しよう<span class="required-item">（必須）</span></label>
          <div class="form-p">
            <i class="fas fa-flag"></i>目標
            <input class="create-input" type="text" name="title" value="{{ old('title') }}">
          </div>
          <label for=""><span class="create-step">Step2.</span>達成日を決めよう<span class="required-item">（必須）</span></label>
          <div class="form-p">
